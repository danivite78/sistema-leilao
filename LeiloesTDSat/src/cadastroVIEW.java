...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    public cadastroVIEW() {
        ...
        setTitle("Sistema de Leilões - Cadastro");
    }
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            // Converte o valor para double, tratando vírgula ou ponto
            double valor;
            try {
            ...
            produto.setValor(valor);  // Agora é double
            ...
            cadastroNome.requestFocus(); // Coloca o foco no campo nome
